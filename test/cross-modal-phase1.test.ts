...
describe('D2 — knobsHash differs across cross-modal knob values', () => {
  ...
  test('KNOBS_HASH_VERSION is 12 (cross-modal still appended; 11→12 per-type retrieval weights)', () => {
    ...
    // document-side query vectors. 11→12: per-type retrieval weights (inbox
    // downweight) add the tw= fingerprint part.
