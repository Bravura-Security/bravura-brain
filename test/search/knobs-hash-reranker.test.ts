...
describe('KNOBS_HASH_VERSION + version invariants', () => {
  test('version is 12 (…; 9→10 relational recall; 10→11 asymmetric input_type #1400; 11→12 per-type retrieval weights)', () => {
    ...
    // per-type retrieval weights: 11→12 to fold the tw= fingerprint (inbox
    // downweight) — a search.type_weights.* change re-ranks results.
